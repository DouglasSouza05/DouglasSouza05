...
My name is Douglas Souza, a Backend Developer with an interest in Web and Embedded Systems ❤. I am a Computer Engineer Graduated at INATEL (National Institute of Telecommunications) in Brazil 🎓. Currently living in Pouso Alegre, Minas Gerais, and seeking opportunities to deepen my knowledge in Software Development 👀.
So far, I have gained experience with different programming languages such as C++, Java and Python, creation of Unit Tests and Mocks, practices of Continuous Integration and Continuous Deployment (CI/CD) 🤖, basic knowledge of Frameworks and Libraries such as ExpressJS, Windows Forms and PyQt5, and Pipeline structuring with Github Actions and Jenkins 🔥. 
